...
import YogeeChintu from '../assets/YogeeChintu.pdf';
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1>{`Hi.. I'm Yogeeshwar Reddy`} <span className="txt-rotate" dataPeriod="10000" data-rotate='[ "Web Developer", "Front-end Developer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <a href={YogeeChintu} download className="btn-download">
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "" : ""}>
                  <div className="image-circle" style={{width:'50%',height:'50%'}}>
                    <img src={heroimage3} alt="Header Img" style={{marginLeft:'8px'}}/>
                  </div>
                </div>}
            </TrackVisibility>
          </Col>
